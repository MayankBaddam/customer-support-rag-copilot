...
| `POST` | `/api/v1/copilot/ask` | Generate grounded answer |
...
EMBEDDING_MODEL=replace_with_selected_model
EMBEDDING_DIMENSION=replace_with_exact_dimension
...
5. Deploy.
6. Copy the final Vercel origin into the backend `FRONTEND_URL` and CORS allowlist.
